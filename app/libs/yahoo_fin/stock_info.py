...
def tickers_sp500(include_company_data = False):
    ...
    sp500 = {key: value for key, value in zip(sp500["Symbol"], sp500["Security"])}
...
def tickers_cac(include_company_data=False):
    ...
    cac_tickers = {key: value for key, value in zip(cac["Ticker"], cac["Company"])}
...
def tickers_dow(include_company_data = False):
    ...
    dow_tickers = {key: value for key, value in zip(table["Symbol"], table["Company Name"])}
