...
class Ui_IndicatorSettingsDialogWindow(object):
    def setupUi(self, IndicatorSettingsDialogWindow):
        ...
        self.lst_inputs = QListWidget(self.wgt_settings_input)
        self.lst_inputs.setObjectName(u"lst_inputs")

        self.verticalLayout_3.addWidget(self.lst_inputs)
        ...
        self.lst_styles = QListWidget(self.wgt_settings_styles)
        self.lst_styles.setObjectName(u"lst_styles")

        self.verticalLayout_2.addWidget(self.lst_styles)
