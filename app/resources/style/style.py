...
def _apply_base_theme(app):
    ...
    with open(os.path.join(SCRIPT_PATH, "style.qss")) as stylesheet:
...
def dark(app):
    ...
    darkPalette.setColor(
        QtGui.QPalette.WindowText, QtGui.QColor(180, 180, 180)
    )
    ...
    darkPalette.setColor(
        QtGui.QPalette.BrightText, QtGui.QColor(180, 180, 180)
    )
    darkPalette.setColor(
        QtGui.QPalette.ButtonText, QtGui.QColor(180, 180, 180)
    )
    ...
    darkPalette.setColor(
        QtGui.QPalette.HighlightedText, QtGui.QColor(180, 180, 180)
    )
    darkPalette.setColor(QtGui.QPalette.Link, QtGui.QColor(56, 252, 196))
    darkPalette.setColor(
        QtGui.QPalette.AlternateBase, QtGui.QColor(66, 66, 66)
    )
    darkPalette.setColor(QtGui.QPalette.ToolTipBase, QtGui.QColor(53, 53, 53))
    darkPalette.setColor(
        QtGui.QPalette.ToolTipText, QtGui.QColor(180, 180, 180)
    )
...
def light(app):
    ...
    lightPalette.setColor(
        QtGui.QPalette.AlternateBase, QtGui.QColor(225, 225, 225)
    )
    lightPalette.setColor(
        QtGui.QPalette.ToolTipBase, QtGui.QColor(240, 240, 240)
    )
    lightPalette.setColor(QtGui.QPalette.ToolTipText, QtGui.QColor(0, 0, 0))
    lightPalette.setColor(
        QtGui.QPalette.LinkVisited, QtGui.QColor(222, 222, 222)
    )
